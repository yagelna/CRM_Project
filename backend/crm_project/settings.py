...
USE_PROD_DB = get_env_variable('USE_PROD_DB', default='False') == 'True'
...
SYSTEM_EMAIL_RECIPIENTS = get_list_env_variable('SYSTEM_EMAIL_RECIPIENTS')
...
MFA_ISSUER = get_env_variable('MFA_ISSUER', default='DotzHub')