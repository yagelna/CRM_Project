...
class InventoryItem(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True) # selling price
    cost = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True) # purchase price
